...
<body>
	<div class="admin-shell">
		...
		<div class="main">
			<header class="topbar">
				<div class="left"><div class="page-title">Éditer le tag</div></div>
				<div class="actions">
			...
			<main class="container">
				<section class="card">
					...
					<form method="post" novalidate>
						...
						<input id="name" name="name" type="text" required value="<?php echo e($tag['name']); ?>">
